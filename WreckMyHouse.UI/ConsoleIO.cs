...
namespace WreckMyHouse.UI
{
    public class ConsoleIO
    {
        ...
        private const string INVALID_INT_BOOL
    = "[INVALID] Please enter '1' or '2'.";
        ...
        public bool ReadIntBool(string prompt)
        {
            while (true)
            {
        ...
        public DateTime ReadNewDate(string prompt, DateTime oldDate) 
        {
            DateTime result;
            while (true)
            {
